      ...
      builder: (context, state) {
        return Scaffold(
          ...
          body: ConditionalBuilder(
                      ...
                      child: InkWell(
                        ...
                        onTap: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>ChatsScreen2(
                            uid: AppCubit.get(context).users[index].uid,
                            name: AppCubit.get(context).users[index].name,
                            image: AppCubit.get(context).users[index].image,
                          )));
                        },
                        child: Row(
              ...
              fallback: (context)=> Center(child: CircularProgressIndicator(color: Colors.blue.shade900,),)
          )
        );
      },
    );
